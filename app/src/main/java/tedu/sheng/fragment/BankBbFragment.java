 ...
 */
public class BankBbFragment extends Fragment implements Consts{
    View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v=inflater.inflate(R.layout.fragment_bank_bb,null);
        app= (MyApplication) getActivity().getApplication();
        lvBb= (ListView) v.findViewById(R.id.lv_bb);
    ...
    private void setListener() {
       /* lvBb.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
...
*/
        lvBb.setOnScrollListener(new AbsListView.OnScrollListener() {
                    ...
                    case SCROLL_STATE_IDLE:
                        if(atBottom){
                            ...
                            new Thread(){
                                @Override
                                public void run() {
                                    String path = HostURL.getEn(songs.size(), 20);
    ...
    private void getSongs() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                String path = HostURL.getEn(0, 20);
