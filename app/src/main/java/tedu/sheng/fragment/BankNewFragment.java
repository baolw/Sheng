 ...
 */
public class BankNewFragment extends Fragment implements Consts{
    View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        lvNew= (ListView) v.findViewById(R.id.lv_new);
    ...
    private void setListener() {
        ...
        lvNew.setOnScrollListener(new AbsListView.OnScrollListener() {
    ...
    private void getSongs() {
        new Thread(new Runnable() {
            @Override
            public void run() {
                String path = HostURL.getNew(0, 20);
